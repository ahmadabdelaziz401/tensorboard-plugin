...
py_library(
    name = "greeter_plugin_dir",
    srcs = ["greeter_plugin.py","threading_tcp_server_with_process.py", "server_handler.py"],
...
py_binary(
    name = "greeter_demo",
    srcs = ["greeter_demo.py","threading_tcp_server_with_process.py", "server_handler.py"],
    srcs_version = "PY2AND3",
...
py_library(
    ...
    srcs = ["greeter_summary.py","threading_tcp_server_with_process.py", "server_handler.py"],
    srcs_version = "PY2AND3",
)
